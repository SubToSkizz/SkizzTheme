...
/* === FINAL PHONK DARK FIX === */
.theme-dark,
.theme-light {
  --background-primary: rgba(0, 0, 0, 0.7) !important;
  --background-secondary: rgba(0, 0, 0, 0.75) !important;
  --background-tertiary: rgba(0, 0, 0, 0.8) !important;
  --background-floating: rgba(0, 0, 0, 0.85) !important;
  --channeltextarea-background: rgba(0, 0, 0, 0.7) !important;
}

/* effet flou / léger éclaircissement global */
#app-mount {
  backdrop-filter: blur(6px) brightness(0.85) !important;
}
