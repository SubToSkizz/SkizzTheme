...
@import url("url.server.on.top.css");
/* SETTINGS */
:root {
  /* ACCENT COLORS */
  ...
  --background-image: url(https://i.imgur.com/vCOa19Q.jpg); /* app background image (link must be HTTPS) [default: url(https://i.imgur.com/vCOa19Q.jpg)]*/
...
/* FIXED DARK THEME - Phonk Balanced */
:is(.theme-darker, .theme-light .theme-darker) {
  --background-shading: rgba(0, 0, 0, 0.4); /* un peu plus clair */
  --card-shading: rgba(0, 0, 0, 0.25);
  --popout-shading: rgba(0, 0, 0, 0.5);
  --modal-shading: rgba(0, 0, 0, 0.35);
  --input-shading: rgba(255, 255, 255, 0.08); /* champs légèrement visibles */
  --normal-text: #ffffff; /* texte blanc net */
  --muted-text: #b5b5b5; /* texte gris doux */
}
...
/* === PHONK ULTRA DARK CLEAN === */
.theme-dark, .theme-light {
  /* fonds unifiés */
  --background-primary: rgba(0, 0, 0, 0.85) !important;
  --background-secondary: rgba(0, 0, 0, 0.9) !important;
  --background-tertiary: rgba(0, 0, 0, 0.95) !important;
  --background-floating: rgba(0, 0, 0, 0.8) !important;
  --channeltextarea-background: rgba(0, 0, 0, 0.8) !important;

  /* couleur du texte */
  --text-normal: #d3d3d3 !important;
  --text-muted: #a1a1a1 !important;
  --interactive-normal: #bfbfbf !important;
  --interactive-hover: #e1e1e1 !important;
  --interactive-active: #ffffff !important;
  --interactive-muted: #666 !important;

  /* suppression des accents colorés (bleu / rouge) */
  --main-color: #a9a9a9 !important;
  --hover-color: #ffffff !important;
  --brand-experiment: #a9a9a9 !important;
  --brand-experiment-560: #707070 !important;
  --brand-experiment-600: #808080 !important;
  --brand-experiment-hover: #999999 !important;

  /* boutons sobres */
  --button-primary-background: #1a1a1a !important;
  --button-primary-hover-background: #333333 !important;
  --button-secondary-background: #1a1a1a !important;
  --button-secondary-hover-background: #333333 !important;
}

/* fond flouté légèrement éclairci */
#app-mount {
  backdrop-filter: blur(4px) brightness(0.85) !important;
}

/* supprime les reflets colorés sur les liens et sélecteurs */
a,
button,
span {
